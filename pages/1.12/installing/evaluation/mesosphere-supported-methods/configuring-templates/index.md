...
excerpt: Advanced templating reference for the Mesosphere Universal Installer
navigationTitle: Template Configuration
menuWeight: 10
---
...
Below is an example of a custom `main.tf` that provisions a customized DC/OS 1.12.0 cluster on AWS. Scroll down to the [inputs reference](#inputs) to see available options.
