...
Now you have configured Edge-LB to connect to your Kubernetes clusters. In the next and last major step, you will [test connections and view the Kubernetes Dashboard](../getting-started/connecting-to-kubernetes/test-connect/) via a web proxy on your browser.
