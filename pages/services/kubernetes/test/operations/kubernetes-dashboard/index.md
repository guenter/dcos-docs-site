...
Once [the Kubernetes API is exposed correctly and kubectl set up](/services/kubernetes/test/connecting-clients), you will be able to access the Kubernetes Dashboard by running:
...
In DC/OS, and as described in [Customizing](/services/kubernetes/test/customizing-install), a certificate authority is automatically generated when installing the package.
...
In DC/OS Enterprise, and as described in [Customizing](/services/kubernetes/test/customizing-install), the centralized [DC/OS CA](/1.12/security/ent/tls-ssl/) is used in order to provide TLS certificates for the Kubernetes cluster.
